    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (sentToken) {
                    Toast.makeText(SplashActivity.this, getString(R.string.gcm_send_message), Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(SplashActivity.this, getString(R.string.token_error_message), Toast.LENGTH_LONG).show();
                }
            }
        };
